...
class DAQTask(Task):
    ...
    def generate(self, data, clear_task=True):
        ...
        if clear_task:
            self.WaitUntilTaskDone(10.)  # 1. 9. 2016
            self.ClearTask()
...
# DAQmx_Val_GroupByChannel [ch0, ch0, ch0, ch1, ch1, ch1, ch2, ch2, ch2]
# DAQmx_Val_GroupByScanNumber [ch0, ch1, ch2, ch0, ch1, ch2, ch0, ch1, ch2]